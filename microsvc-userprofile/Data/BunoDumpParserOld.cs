...
{
    //public class BunoDumpParserOld
    //{
    ...
    //    public BunoDumpParserOld(string csvPath)
    //    {
    //        BunoCsvPath = csvPath;
    //    }
    ...
    //        {
    //            csv.Context.RegisterClassMap<SecurityGroupMapOld>();
    ...
    //public class SecurityGroupMapOld : ClassMap<SecurityGroupFlatDump>
    //{
    //    public SecurityGroupMapOld()
    //    {
